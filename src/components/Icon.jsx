...
export default function Icon({ name, color }) {
  switch (name) {
    ...
    case 'check-square':
      return <CheckSquare color={color} />;
    case 'plus':
...
function Home({ color }) {
  return (
    <svg
      ...
      className={`feather feather-home ${styles.icon}`}
    >
...
function ShoppingCart({ color }) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`feather feather-shopping-cart ${styles.icon}`}
    >
...
function Settings({ color }) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`feather feather-settings ${styles.icon}`}
    >
...
function CheckSquare({ color }) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`feather feather-check-square ${styles.icon}`}
    >
...
function Plus({ color }) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`feather feather-plus ${styles.icon}`}
    >
